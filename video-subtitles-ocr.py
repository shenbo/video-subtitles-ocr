...
def download_tessdata(url, savepath):
    ...
    def reporthook(a, b, c):
        percent = a * b * 100.0 / c
        print(f'\r - downloading: {percent:5.2f}%', end='')
    ...
    print(f'File size = {filesize/1024/1024:.2f} Mb')  # Bytes转换为Mb


# 注意设置路径: $ tesseract --list-langs
# https://github.com/tesseract-ocr/tessdata
tessdata_dir = 'C:/Users/bo/scoop/persist/tesseract/tessdata/'
